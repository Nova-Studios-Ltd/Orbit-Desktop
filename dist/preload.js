...
contextBridge.exposeInMainWorld("electron", {
    ipcRenderer: {
        send: function (channel) {
            ...
            ipcRenderer.send.apply(ipcRenderer, __spreadArray([channel], data, false));
        },
        on: function (channel, func) {
            ipcRenderer.on(channel, function (event) {
                ...
                try {
                    ...
                    console.error("Failed to exe-cute ".concat(channel, " with ").concat(e));
                }
            });
        },
        ...
        invoke: function (channel) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ipcRenderer.invoke.apply(ipcRenderer, __spreadArray([channel], data, false))];
                        case 1:
                            v = _a.sent();
                            return [2 /*return*/, v];
                    }
        ...
        sendSync: function (channel) {
            ...
            return ipcRenderer.sendSync.apply(ipcRenderer, __spreadArray([channel], data, false));
        }
    }
});
